...
<head>
    ...
    <meta name="twitter:image" content="https://acab.city/api/preview/${encodeURI(gcsPath)}">
    ...
    <meta property="og:image" content="https://acab.city/api/preview/${encodeURI(gcsPath)}" />
